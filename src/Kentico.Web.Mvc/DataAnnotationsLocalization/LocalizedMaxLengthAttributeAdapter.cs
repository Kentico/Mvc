...
{
    /// <summary>
    /// Provides an adapter for the <see cref="MaxLengthAttribute"/> attribute that localizes error messages in validation errors and client validation rules.
    /// </summary>
    internal class LocalizedMaxLengthAttributeAdapter : MaxLengthAttributeAdapter
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocalizedMaxLengthAttributeAdapter"/> class.
        /// </summary>
        /// <param name="metadata">The model metadata.</param>
        /// <param name="context">The controller context.</param>
        /// <param name="attribute">The <see cref="MaxLengthAttribute"/> attribute.</param>
