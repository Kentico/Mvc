...
{
    /// <summary>
    /// Provides an adapter for the <see cref="RegularExpressionAttribute"/> attribute that localizes error messages in validation errors and client validation rules.
    /// </summary>
    internal class LocalizedRegularExpressionAttributeAdapter : RegularExpressionAttributeAdapter
    {
        /// <summary>
