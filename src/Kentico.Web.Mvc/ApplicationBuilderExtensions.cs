...
namespace Kentico.Web.Mvc
{
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        /// </summary>
        /// <param name="builder">The application builder.</param>
        public static void UseResourceSharingWithAdministration(this ApplicationBuilder builder)
        {
            builder.RegisterModule(new CrossOriginResourceSharingWithCurrentSiteModule());
        }
    }
}
