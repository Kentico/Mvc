...
namespace CMS.DocumentEngine.Types
{
	...
	public partial class AboutUsProvider
	{
		...
		{
			return GetAboutUs().OnSite(siteName).Culture(cultureName).WhereEquals("NodeID", nodeId);
		}
		...
		{
			return GetAboutUs().OnSite(siteName).Culture(cultureName).WhereEquals("NodeGUID", nodeGuid);
		}
		...
		{
			return GetAboutUs().OnSite(siteName).Culture(cultureName).Path(nodeAliasPath);
		}
	}
}