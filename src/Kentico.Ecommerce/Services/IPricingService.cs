...
namespace Kentico.Ecommerce
{
    ...
    public interface IPricingService : IService
    {
        ...
        ProductPrice CalculatePrice(SKUInfo product, ShoppingCart cart);
        ...
        ProductPrice CalculatePrice(Variant variant, ShoppingCart cart);
        ...
        ShippingPrice CalculateShippingOptionPrice(ShippingOptionInfo shippingInfo, ShoppingCart cart);
